...
I'd like to take an interactive tutorial on building a personal website using Cursor and vibe coding.

Before you do anything technical, start by introducing yourself warmly. Don't create files, run commands, or take any actions yet. Have a short conversation with me first:

1. Tell me what we'll accomplish together (I'll have a real website by the end)
2. Ask my name and what I do
3. Ask what I'm hoping to get out of this session
